...
import { staticRoutes } from '@/router/routes.auth'
...
function getAllRoutes() {
  ...
  tableData.value = arrayToTree(staticRoutes)
  endLoading()
}
...
<template>
  <n-card>
    ...
    <n-data-table
      ...
      :scroll-x="1200"
    />
    <TableModal ref="tableModalRef" :all-routes="tableData" :modal-name="$t('setting.menuEntity')" />
  </n-card>
</template>
