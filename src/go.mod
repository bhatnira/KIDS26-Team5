...
require (
	...
	github.com/hashicorp/nomad/api v0.0.0-20250724161624-b91d1726ce22
	...
	trpc.group/trpc-go/trpc-agent-go/model/gemini v1.10.0
...
require (
	...
	github.com/daytonaio/daytona/libs/api-client-go v0.179.0 // indirect
	github.com/daytonaio/daytona/libs/toolbox-api-client-go v0.179.0 // indirect
	...
	trpc.group/trpc-go/trpc-agent-go/storage/postgres v1.10.0 // indirect
