...
depends_on: ["gene-regulatory-networks/scenic-regulons","gene-regulatory-networks/multiomics-grn","gene-regulatory-networks/perturbation-simulation","single-cell/clustering"]
primary_tool: "pySCENIC"
qc_checkpoints: [{"after_grn_inference":"50-500 regulons detected, known TFs present"},{"after_activity_scoring":"AUCell scores separate known cell types"},{"after_perturbation":"Predicted shifts match known biology"}]
tool_type: "python"
workflow: true
---
