...
depends_on: ["read-qc/adapter-trimming","microbiome/amplicon-processing","microbiome/taxonomy-assignment","microbiome/diversity-analysis","microbiome/differential-abundance","microbiome/functional-prediction"]
primary_tool: "DADA2"
qc_checkpoints: [{"after_denoising":"Per-sample reads tracked through filter/denoise/merge/nonchim; no merge cliff"},{"after_diversity":"Sampling depth declared; dropped-sample list reported"},{"after_da":"Consensus of \u003e=2 CoDA tools on unrarefied counts; tools named"}]
tool_type: "mixed"
workflow: true
---
