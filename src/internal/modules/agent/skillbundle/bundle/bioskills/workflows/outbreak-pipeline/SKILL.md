...
depends_on: ["epidemiological-genomics/pathogen-typing","epidemiological-genomics/amr-surveillance","epidemiological-genomics/phylodynamics","epidemiological-genomics/transmission-inference","epidemiological-genomics/variant-surveillance"]
primary_tool: "mlst"
qc_checkpoints: [{"after_typing":"Valid ST assigned (7-locus mlst); cgMLST via chewBBACA is deferred to epidemiological-genomics/pathogen-typing"},{"after_amr":"AMR genes identified; AMRFinderPlus applies its curated per-gene thresholds (it does not use a flat 90% identity cutoff)"},{"after_phylodynamics":"Root-to-tip R2 \u003e=0.3, clock rate plausible"},{"after_transmission":"Transmission pairs consistent with epi data"}]
tool_type: "mixed"
workflow: true
---
