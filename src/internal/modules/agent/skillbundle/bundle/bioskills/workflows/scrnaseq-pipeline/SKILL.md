...
depends_on: ["single-cell/data-io","single-cell/preprocessing","single-cell/doublet-detection","single-cell/clustering","single-cell/markers-annotation"]
goal_approach_exempt: true
primary_tool: "Seurat"
qc_checkpoints: [{"after_loading":"Expected cell count, reasonable UMI distribution"},{"after_qc":"Remove low-quality cells and doublets"},{"after_normalization":"No batch effects, HVGs look sensible"},{"after_clustering":"Clusters are biologically meaningful"}]
tool_type: "mixed"
workflow: true
---
