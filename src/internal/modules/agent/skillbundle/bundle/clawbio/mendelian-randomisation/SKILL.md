...
description: Two-sample Mendelian Randomisation from GWAS summary statistics with IVW, MR-Egger, weighted median/mode, and full sensitivity analysis (Cochran Q, Egger intercept, Steiger, F-statistic, leave-one-out).
license: "MIT"
metadata: {"author":"Reza","demo_data":[{"description":"30 synthetic BMI-\u003eT2D instruments for offline demo","path":"example_data/demo_instruments.json"}],"dependencies":{"packages":["numpy\u003e=1.24","scipy\u003e=1.10","matplotlib\u003e=3.7"],"python":"\u003e=3.10"},"domain":"genetic-epidemiology","endpoints":{"cli":"python skills/mendelian-randomisation/mendelian_randomisation.py --instruments {input_file} --output {output_dir}"},"inputs":[{"description":"Harmonised instrument JSON with exposure/outcome effect sizes","format":["json"],"name":"instruments","required":true,"type":"file"}],"openclaw":{"always":false,"emoji":"🫛","homepage":"https://github.com/ClawBio/ClawBio","install":[{"kind":"pip","package":"numpy"},{"kind":"pip","package":"scipy"},{"kind":"pip","package":"matplotlib"}],"os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["mendelian randomisation","mendelian randomization","MR analysis","two-sample MR","causal inference genetics","IVW","MR-Egger","instrumental variable","drug target validation MR","GWAS causal"]},"outputs":[{"description":"STROBE-MR aligned interpretation report","format":"md","name":"report","type":"file"},{"description":"Machine-readable MR estimates and sensitivity results","format":"json","name":"result","type":"file"}],"tags":["mendelian-randomisation","causal-inference","two-sample-mr","ivw","mr-egger","gwas","genetic-epidemiology","drug-target-validation"],"version":"0.1.0"}
---
