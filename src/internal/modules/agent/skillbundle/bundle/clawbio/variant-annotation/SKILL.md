...
license: "MIT"
metadata: {"author":"Toby Clark","demo_data":[{"description":"Bundled synthetic 20-variant VCF used for demo mode","path":"example_data/synthetic_clinvar_panel.vcf"}],"domain":"genomics","inputs":[{"description":"Input VCF containing variant records and optional sample genotype columns","format":["vcf","vcf.gz"],"name":"input","type":"file"}],"openclaw":{"always":false,"emoji":"🧬","homepage":"https://github.com/ClawBio/ClawBio","install":[{"kind":"uv","package":"pysam"},{"kind":"uv","package":"requests"}],"os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["vcf","variant annotation","vep","clinvar","gnomad","annotate variants","pathogenic variants"]},"outputs":[{"description":"Variant annotation summary report with prioritized findings","format":"markdown","name":"report","type":"file"},{"description":"Machine-readable annotation results and summary metrics","format":"json","name":"result","type":"file"},{"description":"Flat per-variant annotation table with consequence, ClinVar, and frequency fields","format":"tsv","name":"annotated_variants","type":"file"},{"description":"Reproduction commands and run metadata for the analysis","name":"reproducibility","type":"directory"}],"tags":["genomics","vcf","variant-annotation","vep","clinvar","gnomad"],"version":"0.1.0"}
---
