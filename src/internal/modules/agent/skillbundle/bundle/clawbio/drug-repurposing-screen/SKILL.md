...
description: Objective-driven pooled viability screen analysis:QC, hit calling, context-selectivity, biomarker sweep, and ranked repurposing candidates. Format-agnostic via schema.yaml + objective.yaml; includes offline demo.
license: "MIT"
metadata: {"author":"RezaJF","demo_data":[{"description":"Synthetic 10-sample x 20-compound toy bundle (two contexts, three selective hits).","path":"demo/"}],"dependencies":{"packages":["numpy\u003e=1.24","pandas\u003e=2.0","scipy\u003e=1.10","pyyaml\u003e=6.0","pyarrow\u003e=14.0"],"python":"\u003e=3.10"},"domain":"pharmacogenomics","endpoints":{"cli":"python skills/drug-repurposing-screen/drug_repurposing_screen.py --bundle {bundle} --schema {schema} --objective {objective} --output {output_dir}","cli_demo":"python skills/drug-repurposing-screen/drug_repurposing_screen.py --demo --output {output_dir}"},"inputs":[{"description":"Screen bundle laid out per schema.yaml (readouts, treatment_info, sample_info, optional features/). Use --demo for a bundled toy dataset.","format":["csv","yaml"],"name":"bundle","required":false,"type":"directory"},{"description":"Bundle layout + column/control/qc/hit-calling parameters.","format":["yaml"],"name":"schema","required":false,"type":"file"},{"description":"Repurposing goal: target/off-target contexts (sample_info queries), compound filters, priority weights.","format":["yaml"],"name":"objective","required":false,"type":"file"}],"openclaw":{"always":false,"emoji":"💊","homepage":"https://github.com/ClawBio/ClawBio","install":[{"bins":null,"kind":"pip","package":"numpy"},{"bins":null,"kind":"pip","package":"pandas"},{"bins":null,"kind":"pip","package":"scipy"},{"bins":null,"kind":"pip","package":"pyyaml"},{"bins":null,"kind":"pip","package":"pyarrow"}],"os":["darwin","linux"],"requires":{"bins":["python3"],"config":null,"env":null},"trigger_keywords":["drug repurposing","repurposing screen","viability screen","PRISM","compound panel","selective killing biomarker","pooled viability analysis","context-selective compound"]},"outputs":[{"description":"Markdown and HTML report with top candidates.","format":["md","html"],"name":"report","type":"file"},{"description":"Machine-readable summary plus top-20 priority records.","format":["json"],"name":"result","type":"file"},{"description":"priority_table.csv, selectivity.csv, biomarker_univariate_all_matrices.csv","format":["csv"],"name":"tables","type":"directory"},{"description":"qc_primary, primary_hits, selectivity, biomarkers, priority parquet snapshots.","format":["parquet"],"name":"cache","type":"directory"}],"tags":["drug-repurposing","viability-screen","dose-response","biomarker","cell-line-panel"],"version":"0.1.0"}
---
