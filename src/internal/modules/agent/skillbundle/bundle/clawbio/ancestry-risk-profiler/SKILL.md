...
description: Infers genetic super-population ancestry from a 23andMe/AncestryDNA file and computes ancestry-stratified odds ratios with an exploratory Ancestry Elevation Score (AES) showing where ancestry-specific GWAS effect sizes diverge from European reference estimates.
license: "MIT"
metadata: {"author":"ClawBio","demo_data":[{"description":"Synthetic South Asian 23andMe profile with T2D, CAD, and hypertension risk alleles","path":"data/demo_patient_south_asian.txt"}],"dependencies":{"packages":["matplotlib\u003e=3.6"],"python":"\u003e=3.11"},"domain":"population-genetics","endpoints":{"cli":"python skills/ancestry-risk-profiler/ancestry_risk_profiler.py --input {genotype_file} --output {output_dir}"},"inputs":[{"description":"23andMe or AncestryDNA raw data file","format":["txt"],"name":"genotype_file","required":false,"type":"file"}],"openclaw":{"always":false,"emoji":"🧬","homepage":"https://github.com/ClawBio/ClawBio","install":[{"kind":"pip","package":"matplotlib"}],"os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["ancestry risk","population-stratified risk","South Asian diabetes risk","ancestry-aware variant risk","which diseases am I at risk for given my ancestry","ancestry elevation score","APOL1 African kidney","KCNQ1 East Asian diabetes","genetic super-population disease risk"]},"outputs":[{"description":"Ancestry inference + ancestry-stratified OR comparison report","format":["md"],"name":"ancestry_risk_report.md","type":"file"},{"description":"Machine-readable results","format":["json"],"name":"ancestry_risk_result.json","type":"file"},{"description":"Ancestry Elevation Score bar chart (exploratory)","format":["png"],"name":"figures/aes_chart.png","type":"file"}],"tags":["ancestry","disease-risk","population-genetics","gwas","ancestry-stratified"],"version":"1.3.1"}
---
