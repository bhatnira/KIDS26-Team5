...
license: "MIT"
metadata: {"author":"Manuel Corpas","domain":"genomics","inputs":[{"description":"Modern human genotypes","format":"VCF","required":true},{"description":"Archaic reference genotypes (Neanderthal/Denisovan)","format":"VCF","required":true}],"openclaw":{"always":false,"emoji":"🦴","homepage":"https://github.com/ClawBio/ClawBio","os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["archaic introgression","Neanderthal DNA","Denisovan ancestry","IBDmix","Sprime","hmmix","introgressed segments"]},"outputs":[{"description":"Introgression segments with scores and summary statistics","format":"JSON"},{"description":"Genomic coordinates of introgressed segments","format":"BED"}],"version":"0.1.0"}
---
