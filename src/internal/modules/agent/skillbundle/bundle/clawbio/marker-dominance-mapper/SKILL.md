...
license: "MIT"
metadata: {"author":"ClawBio","demo_data":[{"description":"Synthetic six-spot marker expression table","path":"demo_marker_counts.csv"}],"dependencies":{"packages":null,"python":"\u003e=3.10"},"domain":"marker-expression","endpoints":{"cli":"python skills/marker-dominance-mapper/marker_dominance_mapper.py --input {input_file} --output {output_dir}"},"inputs":[{"description":"Spot-level marker count table","format":["csv"],"name":"input_file","required":true,"type":"file"}],"openclaw":{"always":false,"emoji":"🗺️","homepage":"https://github.com/ClawBio/ClawBio","install":null,"os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["marker dominance mapping","map marker spots","marker-based tissue regions"]},"outputs":[{"description":"Marker-dominance map report","format":["md"],"name":"report","type":"file"},{"description":"Machine-readable mapped spots","format":["json"],"name":"result","type":"file"}],"tags":["marker-dominance","spot-map","marker-mapping"],"version":"0.1.0"}
---
