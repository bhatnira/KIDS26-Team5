...
description: Fetch a region of GWAS summary statistics from the NHGRI-EBI GWAS Catalog harmonised collection via tabix-on-FTP. Use when an agent needs GWAS beta / SE / p-value for every variant in a window for one specific study (GCST accession). Input:accession, chromosome, start, end. Output:harmonised TSV slice in canonical format.
license: "MIT"
metadata: {"demo_data":["examples/input.json"],"dependencies":["python\u003e=3.10","pysam\u003e=0.22","pandas\u003e=2.0","requests\u003e=2.28"],"domain":"bioinformatics","endpoints":["https://ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/"],"inputs":[{"description":"GWAS Catalog study accession (e.g. GCST90269602 for cholesterol-VLDL).","name":"accession","required":true,"type":"string"},{"description":"Chromosome name without `chr` prefix.","name":"chromosome","required":true,"type":"string"},{"description":"Region start, 1-based GRCh38.","name":"start_bp","required":true,"type":"integer"},{"description":"Region end, 1-based GRCh38 (inclusive).","name":"end_bp","required":true,"type":"integer"}],"openclaw":{"always":false,"emoji":"🧬","homepage":"https://github.com/ClawBio/ClawBio","install":"pip install pysam pandas requests\n","os":["darwin","linux"],"requires":{"bins":["python3","tabix"],"config":null,"env":null},"trigger_keywords":["gwas region fetch","gwas catalog region","gwas sumstats slice","GCST harmonised tabix","GWAS catalog tabix"]},"outputs":[{"description":"Per-variant rows with variant_id, chromosome, position, ref, alt, beta, se, p_value, allele frequencies.","name":"variants","type":"list"},{"description":"GWASCatalogRelease with accession, harmonised file path, fetched_at_utc.","name":"release","type":"object"}],"skill-author":"Aviv Madar","tags":["gwas","gwas-catalog","region-fetch","tabix","summary-statistics","harmonised"],"version":"0.1.0"}
---
