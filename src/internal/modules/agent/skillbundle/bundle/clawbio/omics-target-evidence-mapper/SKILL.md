...
license: "MIT"
metadata: {"openclaw":{"always":false,"emoji":"🧬","homepage":"https://github.com/ClawBio/ClawBio","os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["target evidence","gene disease evidence","target triage","omics evidence","gene disease mapper"]},"tags":["omics","targets","translational-research","literature","trials"],"version":"0.1.0"}
---
