...
description: Generates professional clinical PDF reports in Spanish from WES (Whole Exome Sequencing) data with clinical interpretation, pharmacogenomic alerts, and follow-up recommendations.
license: "PROPRIETARY"
metadata: {"author":"Manuel Corpas","inputs":[{"description":"Structured WES report with sections 1-7 (Exome Summary through Methods)","format":"markdown (.md)","name":"WES markdown report","required":true},{"description":"Predice institutional logo for cover and header","format":"image (JPG/PNG)","name":"Logo left (Predice)","required":false},{"description":"Inbiomedic institutional logo for cover and header","format":"image (JPG/PNG)","name":"Logo right (Inbiomedic)","required":false}],"openclaw":{"always":false,"dependencies":["reportlab","pandas"],"emoji":"🧬","homepage":"https://github.com/ClawBio/ClawBio","min_python":"3.9","os":["darwin","linux"],"private":true,"requires":{"bins":["python3"]},"trigger_keywords":["informe clinico WES","clinical report spanish","exome PDF report","Novogene report","Predice","Inbiomedic"]},"outputs":[{"description":"Professional clinical report in Spanish with interpretation, tables, and disclaimer","format":"PDF (A4)","name":"Clinical PDF report (Spanish)"}],"tags":["WES","exome","clinical-report","spanish","pharmacogenomics","PDF","ANNOVAR"],"version":"1.0.0"}
---
