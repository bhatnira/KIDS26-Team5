...
license: "MIT"
metadata: {"author":"Manuel Corpas","openclaw":{"always":false,"emoji":"💞","homepage":"https://github.com/ClawBio/ClawBio","os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["genome match","compatibility","mating pairs","genomebook match","heterozygosity score","breeding pairs"]},"tags":["genomebook","compatibility","heterozygosity","disease-risk","mating-selection"],"version":"0.1.0"}
---
