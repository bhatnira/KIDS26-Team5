...
license: "MIT"
metadata: {"author":"ClawBio","openclaw":{"always":false,"emoji":"🔬","homepage":"https://github.com/ClawBio/ClawBio","install":[{"kind":"pip","package":"cellpose\u003e=4.0"},{"kind":"pip","package":"tifffile"},{"kind":"pip","package":"czifile\u003e=2019.7.2.2"},{"kind":"pip","package":"nd2\u003e=0.11.1"},{"kind":"pip","package":"Pillow"},{"kind":"pip","package":"scikit-image"}],"os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["cellpose","cpsam","cell segmentation","nucleus segmentation","fluorescence microscopy","microscopy image","image segmentation","cell counting","segmentation mask"]},"tags":["microscopy","segmentation","cellpose","fluorescence","imaging","cell-biology"],"version":"0.1.0"}
---
