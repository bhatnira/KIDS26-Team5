...
license: "MIT"
metadata: {"author":"Heng Gao \u003cheng.gao25@imperial.ac.uk\u003e","demo_data":[{"description":"Synthetic target validation query for TGFBR1/IPF with pre-cached evidence","path":"demo_input.json"}],"dependencies":{"packages":["pandas\u003e=2.0","matplotlib\u003e=3.7","numpy\u003e=1.24"],"python":"\u003e=3.11"},"domain":"drug-discovery","endpoints":{"cli":"python skills/target-validation-scorer/target_validation_scorer.py --input {input_file} --output {output_dir}"},"inputs":[{"description":"JSON file with target gene symbol and optional disease name","format":["json"],"name":"input_file","required":true,"type":"file"}],"openclaw":{"always":false,"emoji":"🎯","homepage":"https://github.com/ClawBio/ClawBio","install":[{"kind":"pip","package":"matplotlib"},{"kind":"pip","package":"numpy"}],"os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["target validation","is this target druggable","evaluate drug target","GO NO-GO decision for target"]},"outputs":[{"description":"Structured validation report with scoring, evidence trail, and decision rationale","format":"md","name":"report","type":"file"},{"description":"Machine-readable scoring output with evidence objects","format":"json","name":"validation_report.json","type":"file"}],"tags":["drug-discovery","target-validation","evidence-grading","decision-support","kinase"],"version":"1.0.0"}
---
