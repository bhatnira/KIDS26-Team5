...
license: "MIT"
metadata: {"author":"ClawBio","demo_data":[{"description":"A test DOI pointing to a public GEO dataset","path":"examples/demo_article.txt"}],"dependencies":{"packages":["requests\u003e=2.31","biopython\u003e=1.83","tqdm\u003e=4.66","pydantic\u003e=2.0"],"python":"\u003e=3.11"},"domain":"genomics","endpoints":{"cli":"python skills/article-data-fetcher/article_data_fetcher.py --id {article_id} --types {file_types} --output {output_dir}"},"inputs":[{"description":"Article DOI, PubMed ID (PMID), or direct repository URL","format":["doi","pmid","url"],"name":"article_id","required":true,"type":"string"},{"description":"Comma-separated list of file extensions the user wants (e.g. vcf,fasta,h5ad)","format":["free text list"],"name":"file_types","required":true,"type":"string"},{"description":"Local directory to save downloaded files (defaults to ./downloads)","name":"output_dir","required":false,"type":"string"}],"openclaw":{"always":false,"emoji":"🧬","homepage":"https://github.com/ClawBio/ClawBio","install":[{"bins":null,"kind":"pip","package":"requests"},{"bins":null,"kind":"pip","package":"biopython"},{"bins":null,"kind":"pip","package":"tqdm"},{"bins":null,"kind":"pip","package":"pydantic"}],"os":["darwin","linux"],"requires":{"bins":["python3"],"config":null,"env":null},"trigger_keywords":["download data from paper","download genomics data from article","get VCF from paper","get FASTA from study","fetch supplementary data files","download dataset from publication","retrieve genomics files from doi","get raw data from study","download from GEO","download from ENA","fetch h5ad from paper","get csv from publication","article data download","paper dataset download","download research data","get files from zenodo","fetch data from figshare"]},"outputs":[{"description":"The actual data files retrieved from repositories","format":["vcf","fasta","h5ad","csv","tsv","json","bam","fastq","bed","gz","zip"],"name":"downloaded_files","type":"files"},{"description":"Machine-readable record of every file downloaded (source URL, size, checksum)","format":["json"],"name":"manifest.json","type":"file"},{"description":"Human-readable summary of what was found and downloaded","format":["md"],"name":"report.md","type":"file"}],"tags":["data-download","genomics","reproducibility","geo","ena","zenodo"],"version":"0.1.0"}
---
