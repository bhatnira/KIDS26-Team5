...
license: "MIT"
metadata: {"openclaw":{"always":false,"emoji":"🧱","homepage":"https://github.com/ClawBio/ClawBio","install":[{"bins":["boltz"],"comment":"GPU: uv pip install 'boltz[cuda]' -U","kind":"uv","package":"boltz"},{"kind":"uv","package":"numpy"},{"kind":"uv","package":"matplotlib"},{"kind":"uv","package":"pyyaml"}],"os":["darwin","linux"],"requires":{"anyBins":["boltz"],"bins":["python3"]}},"version":"0.2.0"}
---
