...
license: "MIT"
metadata: {"openclaw":{"always":false,"emoji":"🦖","homepage":"https://github.com/ClawBio/ClawBio","install":[{"kind":"uv","package":"biopython"},{"kind":"uv","package":"pandas"},{"kind":"uv","package":"scikit-learn"},{"kind":"uv","package":"matplotlib"},{"kind":"uv","package":"numpy"}],"os":["darwin","linux"],"requires":{"bins":["python3"]}},"version":"0.1.0"}
---
