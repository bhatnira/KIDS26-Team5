...
license: "MIT"
metadata: {"author":"Sooraj (github.com/sooraj-codes)","demo_data":[{"description":"Pre-generated demo report for CRISPR genome editing query","path":"examples/demo_output/report.md"}],"dependencies":{"packages":["biopython\u003e=1.83"],"python":"\u003e=3.11"},"domain":"literature","endpoints":{"cli":"python skills/lit-synthesizer/lit_synthesizer.py --query \"{query}\" --output {output_dir}"},"inputs":[{"description":"Free-text search query (e.g. 'CRISPR off-target effects')","name":"query","required":true,"type":"string"}],"openclaw":{"always":false,"emoji":"📚","homepage":"https://github.com/ClawBio/ClawBio","install":[{"kind":"pip","package":"biopython"}],"os":["darwin","linux"],"requires":{"always":false},"trigger_keywords":["search pubmed","find papers","literature review","search biorxiv","find articles","citation graph","synthesize literature","find research papers","pubmed search","recent papers on"]},"outputs":[{"description":"Structured markdown report with paper summaries and citation graph","format":"md","name":"report","type":"file"}],"tags":["literature","pubmed","biorxiv","citation","synthesis"],"version":"0.1.0"}
---
