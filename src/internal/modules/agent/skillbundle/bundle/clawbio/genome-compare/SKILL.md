...
license: "MIT"
metadata: {"author":"Manuel Corpas","openclaw":{"always":false,"emoji":"🧬","homepage":"https://github.com/ClawBio/ClawBio","os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["genome comparison","IBS","identity by state","George Church","Corpasome","pairwise"]},"tags":["genome-comparison","IBS","ancestry","PGP","admixture"],"version":"0.1.0"}
---
