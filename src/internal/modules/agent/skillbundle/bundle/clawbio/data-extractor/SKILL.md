...
license: "MIT"
metadata: {"openclaw":{"always":false,"emoji":"📊","homepage":"https://github.com/ClawBio/ClawBio","install":[{"kind":"pip","package":"anthropic"},{"kind":"pip","package":"opencv-python-headless"},{"kind":"pip","package":"numpy"},{"kind":"pip","package":"Pillow"},{"kind":"pip","package":"pydantic"},{"kind":"pip","package":"fastapi"},{"kind":"pip","package":"uvicorn"}],"os":["darwin","linux"],"requires":{"bins":["python3"],"env":["ANTHROPIC_API_KEY"]}},"version":"0.1.0"}
---
