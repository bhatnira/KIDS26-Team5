...
license: "MIT"
metadata: {"author":"Daniel Garbozo","demo_data":[{"description":"Pre-generated demo report for two synthetic samples","path":"examples/demo-results/report.md"}],"dependencies":{"packages":null,"python":"\u003e=3.10"},"domain":"genomics","emoji":"🦖","endpoints":{"cli":"python skills/seq-wrangler/seq_wrangler.py --r1 {r1} --r2 {r2} --index {index} --output {output_dir}"},"inputs":[{"description":"FASTQ R1 or single-end reads","format":"fastq.gz","name":"r1","required":true,"type":"file"},{"description":"FASTQ R2 for paired-end mode","format":"fastq.gz","name":"r2","required":false,"type":"file"},{"description":"CSV with columns sample, fastq1, fastq2","format":"csv","name":"samplesheet","required":false,"type":"file"},{"description":"Aligner index prefix (bowtie2-build / bwa index output)","name":"index","required":true,"type":"string"}],"openclaw":{"emoji":"🦖","homepage":"https://github.com/ClawBio/ClawBio","install":null,"os":["darwin","linux"],"requires":{"always":false},"trigger_keywords":["align reads","align fastq","map reads","paired-end alignment","bwa mem","bowtie2","minimap2","fastq to bam","read qc","trim adapters","coverage of bam","flagstat","sort and index bam","process fastq"]},"os":["darwin","linux"],"outputs":[{"description":"Alignment QC report with flagstat, coverage, and insert size","format":"md","name":"report","type":"file"},{"description":"Sorted, duplicate-marked BAM with .bai index","format":"bam","name":"bam","type":"file"}],"tags":["fastq","alignment","bam","qc","bowtie2","bwa","minimap2","samtools","ngs","genomics"],"version":"0.1.0"}
---
