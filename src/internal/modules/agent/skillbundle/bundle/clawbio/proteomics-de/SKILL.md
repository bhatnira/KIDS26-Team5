...
license: "MIT"
metadata: {"openclaw":{"always":false,"emoji":"🥚","homepage":"https://github.com/ClawBio/ClawBio","install":[{"kind":"pip","package":"pandas"},{"kind":"pip","package":"numpy"},{"kind":"pip","package":"matplotlib"},{"kind":"pip","package":"scikit-learn"},{"kind":"pip","package":"scipy"},{"kind":"pip","package":"seaborn"}],"os":["darwin","linux","win32"],"requires":{"bins":["python3"]},"trigger_keywords":["Differential expression analysis of proteomics data from MaxQuant or DIA-NN output"]},"version":"0.1.0"}
---
