...
metadata: {"openclaw":{"always":false,"emoji":"🩸","homepage":"https://github.com/ClawBio/ClawBio","install":[{"bins":null,"kind":"uv","package":"pandas"},{"bins":null,"kind":"uv","package":"numpy"},{"bins":null,"kind":"uv","package":"matplotlib"}],"os":["darwin","linux"],"requires":{"bins":["python3"],"config":null,"env":null}},"tags":["rna-seq","rare-disease","outlier-detection","OUTRIDER","FRASER","diagnostic","blood","transcriptomics","haploinsufficiency"],"trigger_keywords":["rare disease rnaseq","expression outlier","OUTRIDER","FRASER","blood rna-seq diagnostic","NGRL","undiagnosed","candidate diagnosis"],"version":"0.1.0"}
---
