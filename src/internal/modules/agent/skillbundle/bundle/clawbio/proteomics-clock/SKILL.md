...
license: "MIT"
metadata: {"author":"Maria Dermit","demo_data":[{"description":"Synthetic 20-sample Olink NPX dataset (26 proteins)","path":"data/demo_olink_npx.csv.gz"}],"dependencies":{"packages":["pandas\u003e=2.0","numpy\u003e=1.24","matplotlib\u003e=3.7","seaborn\u003e=0.12","requests\u003e=2.28"],"python":"\u003e=3.11"},"domain":"proteomics","endpoints":{"cli":"python skills/proteomics-clock/proteomics_clock.py --input {input_file} --output {output_dir}"},"inputs":[{"description":"Olink NPX protein expression table (samples x proteins)","format":["csv","tsv","csv.gz","tsv.gz"],"name":"input_file","required":true,"type":"file"}],"openclaw":{"always":false,"emoji":"🕰️","homepage":"https://github.com/ClawBio/ClawBio","install":[{"kind":"pip","package":"pandas"},{"kind":"pip","package":"numpy"},{"kind":"pip","package":"matplotlib"},{"kind":"pip","package":"seaborn"},{"kind":"pip","package":"requests"}],"os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["proteomics clock","organ aging","proteomic clock","olink clock","organ clock","goeminne","plasma protein aging","organ-specific aging"]},"outputs":[{"description":"Organ aging analysis report","format":"md","name":"report","type":"file"}],"tags":["proteomics","aging","olink","organ-clock","biological age","Goeminne"],"version":"0.1.0"}
---
