...
license: "MIT"
metadata: {"author":"Jacky Siu","demo_data":[{"description":"Reference output of `--demo` on scanpy's bundled real pbmc3k dataset (gene MS4A1).","path":"examples/expected_demo_profile.json"}],"dependencies":{"packages":["scanpy","anndata","numpy\u003e=1.23","scipy\u003e=1.9","pandas\u003e=2.0"],"python":"\u003e=3.10"},"domain":"single-cell","endpoints":{"cli":"python skills/celltype-specificity-profiler/profiler.py --gene {gene} --atlas {atlas} --output {output_dir}"},"inputs":[{"description":"Annotated single-cell expression matrix (log-normalized X; cell-type labels in an obs column). In the chain, this is the output of upstream scrna-embedding.","format":["h5ad"],"name":"atlas","required":false,"type":"file"},{"description":"HGNC gene symbol to profile (e.g. CD276). Required unless --demo.","format":["txt"],"name":"gene","required":false,"type":"string"}],"openclaw":{"always":false,"emoji":"🎯","homepage":"https://github.com/ClawBio/ClawBio","install":[{"kind":"uv","package":"scanpy"},{"kind":"uv","package":"anndata"},{"kind":"uv","package":"numpy"},{"kind":"uv","package":"scipy"},{"kind":"uv","package":"pandas"}],"os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["cell-type specificity","cell type specificity","specificity index","tau index","tau specificity","bimodality","bimodality coefficient","cell-type-specific expression","expression specificity","marker gene specificity"]},"outputs":[{"description":"Specificity profile — tau, bimodality coefficient, ranked cell types, per-cell-type stats, optional trial prior.","format":["json"],"name":"profile","type":"file"},{"description":"Tidy per-cell-type expression table for plotting.","format":["csv"],"name":"per_celltype","type":"file"}],"tags":["scrna","single-cell","specificity","tau","bimodality","target-prioritization","marker-gene","h5ad"],"version":"0.1.0"}
---
