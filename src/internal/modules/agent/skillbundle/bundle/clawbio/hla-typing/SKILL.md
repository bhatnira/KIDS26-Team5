...
license: "MIT"
metadata: {"author":"Manuel Corpas","demo_data":[{"description":"Synthetic test data","path":"demo_input.txt"}],"dependencies":{"packages":["pandas\u003e=2.0"],"python":"\u003e=3.11"},"domain":"genomics","endpoints":{"cli":"python skills/hla-typing/hla_typing.py --input {input_file} --output {output_dir}"},"inputs":[{"description":"Primary input data file","format":["vcf","csv","tsv","txt"],"name":"input_file","required":true,"type":"file"}],"openclaw":{"always":false,"emoji":"🧬","homepage":"https://github.com/ClawBio/ClawBio","install":[{"kind":"pip","package":"pandas"}],"os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["allele","typing","from"]},"outputs":[{"description":"Analysis report","format":"md","name":"report","type":"file"},{"description":"Machine-readable results","format":"json","name":"result","type":"file"}],"tags":["allele","typing","from"],"version":"0.1.0"}
---
