...
license: "MIT"
metadata: {"author":"Manuel Corpas","openclaw":{"always":false,"emoji":"🧪","homepage":"https://github.com/ClawBio/ClawBio","os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["recombinator","recombination","offspring","breed","meiosis","genomebook breed","next generation"]},"tags":["genomebook","recombination","meiosis","mutation","offspring","clinical-genetics"],"version":"0.1.0"}
---
