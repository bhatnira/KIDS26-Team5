...
license: "MIT"
metadata: {"openclaw":{"always":false,"emoji":"🧬","homepage":"https://api.clinpgx.org/","install":[{"kind":"uv","package":"requests"}],"min_python":"3.10","os":["darwin","linux"],"requires":{"bins":["python3"]}},"version":"0.1.0"}
---
