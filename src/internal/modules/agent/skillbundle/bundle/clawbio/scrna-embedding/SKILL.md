...
license: "MIT"
metadata: {"author":"Yonghao Zhao","openclaw":{"always":false,"emoji":"🧬","homepage":"https://github.com/ClawBio/ClawBio","install":[{"kind":"uv","package":"scanpy"},{"kind":"uv","package":"anndata"},{"kind":"uv","package":"torch"},{"kind":"uv","package":"scvi-tools"}],"os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["scvi","scanvi","embedding","latent","integration","batch correction","batch integration","h5ad","10x"]},"tags":["scrna","single-cell","scvi","scanvi","embedding","integration","batch-correction","h5ad","10x"],"version":"0.1.0"}
---
