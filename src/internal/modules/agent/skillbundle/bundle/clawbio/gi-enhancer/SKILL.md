...
license: "MIT"
metadata: {"author":"ClawBio + Genomic Intelligence","demo_data":[{"description":"Drosophila eve (even-skipped) developmental-enhancer region (chr2R:9972000-9982000, BDGP6, gene-sense, incl. upstream stripe enhancers) — canonical DeepSTARR benchmark.","path":"example_data/enhancer_eve.fa"}],"dependencies":{"packages":["requests\u003e=2.31"],"python":"\u003e=3.10"},"domain":"genomics","endpoints":{"cli":"python skills/gi-enhancer/gi_enhancer.py --input {input_file} --output {output_dir}"},"inputs":[{"description":"Single-record FASTA (any length; API windows automatically).","format":["fa","fasta","fna"],"name":"input_file","required":false,"type":"file"}],"openclaw":{"always":false,"emoji":"🎚️","homepage":"https://docs.genomicintelligence.ai","install":[{"bins":null,"kind":"pip","package":"requests"}],"os":["darwin","linux"],"requires":{"bins":["python3"],"config":null,"env":null},"trigger_keywords":["enhancer","enhancer activity","predict enhancer","regulatory element","cis-regulatory","CRE","DeepSTARR","STARR-seq","massively parallel reporter assay","MPRA","gi enhancer","genomic intelligence enhancer"]},"outputs":[{"description":"Markdown report — windows processed, max predicted activity, model + timing.","format":"md","name":"report","type":"file"},{"description":"Full `{data, meta}` response.","format":"json","name":"result","type":"file"},{"description":"command.sh + environment.json.","name":"reproducibility","type":"directory"}],"tags":["genomics","enhancer","regulatory","cis-regulatory","deepstarr","dna-lm","gi-api"],"version":"0.1.0"}
---
