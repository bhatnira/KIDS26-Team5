---
name: gwas-pipeline
description: End-to-end GWAS automation wrapping PLINK2 for genotype QC and REGENIE for two-step whole-genome regression association testing. Produces Manhattan plots, QQ plots, clumped lead variants, and structured summary statistics.
license: "MIT"
metadata: {"author":"Reza","openclaw":{"always":false,"emoji":"📊","homepage":"https://github.com/ClawBio/ClawBio","install":[{"bins":["plink2"],"kind":"conda","package":"plink2"},{"bins":["regenie"],"kind":"conda","package":"regenie"}],"os":["darwin","linux"],"requires":{"bins":["python3","plink2","regenie"]},"trigger_keywords":["GWAS","genome-wide association","PLINK","REGENIE","association testing","Manhattan plot","QQ plot","polygenic","case-control"]},"tags":["gwas","association-testing","regenie","plink2","population-genetics","biobank","quality-control"],"version":"0.1.0"}
---
