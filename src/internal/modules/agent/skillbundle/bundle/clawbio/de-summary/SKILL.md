...
license: "MIT"
metadata: {"author":"Manuel Corpas","inputs":[{"description":"DESeq2, edgeR, or limma output table with columns: gene_id or gene_name, log2FoldChange, pvalue, padj (adjusted p-value). Optional columns: baseMean, lfcSE, stat.","format":["csv","tsv"],"name":"de_results","required":true,"type":"file"}],"openclaw":{"always":false,"emoji":"📊","homepage":"https://github.com/ClawBio/ClawBio","os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["DE summary","differential expression summary","top DE genes","summarise DE results","interpret DE","volcano summary","gene expression summary"]},"outputs":[{"description":"Structured summary with top DE genes, biological themes, and key observations","format":"md","name":"report","type":"file"},{"description":"Machine-readable ranked gene list, themes, and summary statistics","format":"json","name":"result","type":"file"},{"description":"commands.sh, environment.yml, checksums.sha256","name":"reproducibility","type":"directory"}],"tags":["transcriptomics","differential-expression","summary","interpretation","bulk-rna-seq"],"version":"0.1.0"}
---
