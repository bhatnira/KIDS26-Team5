...
license: "MIT"
metadata: {"author":"David de Lorenzo","openclaw":{"always":false,"emoji":"🥦","homepage":"https://github.com/ClawBio/ClawBio","install":[{"kind":"pip","package":"pandas numpy matplotlib seaborn"},{"kind":"pip","package":"reportlab"}],"os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["personalised nutrition","nutrigenomics","diet genetics","MTHFR","APOE","FTO","vitamin D","caffeine metabolism","lactose","omega-3","folate","what should I eat based on my DNA","vitamin absorption genetics","gluten"]},"tags":["nutrigenomics","nutrition","diet","genetics","23andme","ancestrydna","vcf"],"version":"0.1.0"}
---
