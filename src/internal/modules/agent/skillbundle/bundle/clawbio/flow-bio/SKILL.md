...
license: "MIT"
metadata: {"author":"ClawBio Contributors","demo_data":[{"description":"Pre-cached public Flow.bio data (pipelines, organisms, sample types) for offline demo","path":"data/demo_cache.json"}],"dependencies":{"packages":["requests\u003e=2.28"],"python":"\u003e=3.10"},"domain":"bioinformatics","endpoints":{"cli":"python skills/flow-bio/flow_bio.py --demo --output {output_dir}"},"inputs":[{"description":"First reads file for sample upload","format":["fastq","fq","fastq.gz","fq.gz"],"name":"reads1","required":false,"type":"file"},{"description":"Second reads file for paired-end upload","format":["fastq","fq","fastq.gz","fq.gz"],"name":"reads2","required":false,"type":"file"}],"openclaw":{"always":false,"emoji":"🌊","homepage":"https://flow.bio","install":[{"kind":"pip","package":"requests"}],"os":["darwin","linux"],"requires":{"bins":["python3"],"env":["FLOW_URL","FLOW_TOKEN"]},"trigger_keywords":["flow","flow.bio","flow bio","flow pipeline","flow sample","flow execution","flow project","flow upload","run on flow"]},"outputs":[{"description":"Markdown report of Flow.bio interaction","format":"md","name":"report","type":"file"},{"description":"Machine-readable result envelope","format":"json","name":"result","type":"file"}],"tags":["flow","flow.bio","LIMS","pipelines","samples","nextflow","bioinformatics","cloud"],"version":"0.1.0"}
---
