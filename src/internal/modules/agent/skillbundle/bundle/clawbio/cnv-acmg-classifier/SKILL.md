...
description: Classify structural variants / copy-number variants (deletions and duplications) using the ClinGen / ACMG 2019 (Riggs et al. 2020) point framework and return a five-tier classification with a per-section evidence trail. Germline CNV interpretation, not SNV/indel.
license: "MIT"
metadata: {"author":"ClawBio Contributors","demo_data":[{"description":"Seven synthetic CNVs spanning all five ACMG tiers","path":"demo_cnv_calls.csv"},{"description":"Curated demonstration dosage-sensitivity map","path":"data/curated_dosage_map.csv"},{"description":"Curated demonstration gene model (incl. a 40-gene cluster)","path":"data/curated_gene_model.csv"}],"dependencies":{"packages":null,"python":"\u003e=3.10"},"domain":"clinical-genomics","endpoints":{"cli":"python skills/cnv-acmg-classifier/cnv_acmg_classifier.py --input {input_file} --output {output_dir}"},"inputs":[{"description":"CNV/SV calls (VCF with SVTYPE/END, or a CSV/TSV with cnv_id,chrom,start,end,type)","format":["vcf","csv","tsv"],"name":"input_file","required":true,"type":"file"},{"description":"Optional dosage-sensitivity map (chrom,start,end,name,hi_score,ts_score,benign)","format":["csv"],"name":"dosage_map","required":false,"type":"file"},{"description":"Optional protein-coding gene model (chrom,start,end,gene) for gene counting","format":["csv"],"name":"gene_model","required":false,"type":"file"}],"openclaw":{"always":false,"emoji":"🦖","homepage":"https://github.com/ClawBio/ClawBio","install":null,"os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["CNV classification","copy number variant ACMG","structural variant interpretation","ClinGen dosage sensitivity","deletion duplication pathogenic"]},"outputs":[{"description":"Per-CNV classification report with evidence codes and tier counts","format":["md"],"name":"report","type":"file"},{"description":"Machine-readable classifications with section-by-section evidence","format":["json"],"name":"result","type":"file"}],"tags":["cnv","structural-variant","acmg","clingen","dosage-sensitivity"],"version":"0.1.0"}
---
