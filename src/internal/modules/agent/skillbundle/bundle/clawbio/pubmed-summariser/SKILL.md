...
license: "MIT"
metadata: {"openclaw":{"always":false,"emoji":"📄","homepage":"https://pubmed.ncbi.nlm.nih.gov/","install":[{"kind":"pip","package":"requests"}],"os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["pubmed","summarise papers","research briefing","papers about","recent studies","literature search pubmed","gene papers","disease papers"]},"version":"0.1.0"}
---
