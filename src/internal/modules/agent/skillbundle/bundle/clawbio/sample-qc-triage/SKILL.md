...
license: "MIT"
metadata: {"author":"ClawBio","demo_data":[{"description":"Synthetic five-sample QC metrics table","path":"demo_qc_metrics.csv"}],"dependencies":{"packages":null,"python":"\u003e=3.10"},"domain":"genomics","endpoints":{"cli":"python skills/sample-qc-triage/sample_qc_triage.py --input {input_file} --output {output_dir}"},"inputs":[{"description":"Sample-level QC metrics table with optional identity checks","format":["csv"],"name":"input_file","required":true,"type":"file"}],"openclaw":{"always":false,"emoji":"🔬","homepage":"https://github.com/ClawBio/ClawBio","install":null,"os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["sample QC triage","sequencing QC outliers","sex mismatch","fingerprint concordance","contamination batch shift"]},"outputs":[{"description":"QC triage report","format":["md"],"name":"report","type":"file"},{"description":"Machine-readable sample flags","format":["json"],"name":"result","type":"file"}],"tags":["quality-control","sequencing-qc","triage"],"version":"0.1.0"}
---
