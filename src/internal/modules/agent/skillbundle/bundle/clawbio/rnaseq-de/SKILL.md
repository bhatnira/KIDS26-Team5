...
license: "MIT"
metadata: {"openclaw":{"always":false,"emoji":"🧬","homepage":"https://github.com/ClawBio/ClawBio","install":[{"kind":"uv","package":"pandas"},{"kind":"uv","package":"numpy"},{"kind":"uv","package":"matplotlib"},{"kind":"uv","package":"scikit-learn"}],"os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["rna-seq","differential expression","bulk RNA","pseudo-bulk","volcano plot","ma plot","count matrix","DESeq2","pydeseq2"]},"tags":["rna-seq","differential expression","bulk","pseudo-bulk","transcriptomics","DESeq2","PyDESeq2","QC","PCA"],"version":"0.1.0"}
---
