...
license: "MIT"
metadata: {"author":"Sooraj (github.com/sooraj-codes)","demo_data":[{"description":"Pre-generated demo report for 5 clinically relevant variants","path":"examples/demo_output/report.md"}],"dependencies":{"packages":null,"python":"\u003e=3.11"},"domain":"genomics","emoji":"🧬","endpoints":{"cli":"python skills/vcf-annotator/vcf_annotator.py --input {input} --output {output_dir}"},"inputs":[{"description":"VCF file (VCFv4.x, GRCh38)","format":"vcf","name":"input","required":true,"type":"file"}],"openclaw":{"emoji":"🧬","homepage":"https://github.com/ClawBio/ClawBio","install":null,"os":["darwin","linux"],"requires":{"always":false},"trigger_keywords":["annotate vcf","annotate variants","variant annotation","clinvar lookup","gnomad frequency","vep annotation","pathogenic variants","variant effect","annotate my vcf","what variants are pathogenic"]},"os":["darwin","linux"],"outputs":[{"description":"Annotated variant report with ClinVar, gnomAD, and VEP results","format":"md","name":"report","type":"file"}],"tags":["vcf","variants","annotation","clinvar","gnomad","vep","genomics"],"version":"0.1.0"}
---
