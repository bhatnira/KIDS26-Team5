...
description: Interactive Goeminne proteomic aging clock with organ filters and per-protein contribution breakdown (protein NPX × coefficient). Agent- and demo-friendly.
license: "MIT"
metadata: {"author":"ClawBio hackathon contributor","demo_data":[{"description":"Synthetic 20-sample Olink NPX demo (shared with proteomics-clock)","path":"../proteomics-clock/data/demo_olink_npx.csv.gz"}],"dependencies":{"packages":["pandas\u003e=2.0","numpy\u003e=1.24","requests\u003e=2.28"],"python":"\u003e=3.11"},"domain":"proteomics","endpoints":{"cli":"python skills/organ-aging-studio/organ_aging_studio.py --input {input_file} --output {output_dir}"},"inputs":[{"description":"Olink NPX protein table (samples × proteins)","format":["csv","tsv","csv.gz","tsv.gz"],"name":"input_file","required":true,"type":"file"}],"openclaw":{"always":false,"emoji":"🕰️","homepage":"https://github.com/ClawBio/ClawBio","install":[{"kind":"pip","package":"pandas"},{"kind":"pip","package":"numpy"},{"kind":"pip","package":"requests"}],"os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["organ aging studio","proteomic clock breakdown","protein coefficient aging","Goeminne clock explain","which proteins drive organ age"]},"outputs":[{"description":"Human-readable aging report with per-organ summary","format":["md"],"name":"report","type":"file"},{"description":"Machine-readable predictions and protein contributions","format":["json"],"name":"result","type":"file"}],"tags":["aging","longevity","proteomics","biological age","organ clock","Goeminne","interpretability"],"version":"0.1.0"}
---
