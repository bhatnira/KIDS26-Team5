...
license: "MIT"
metadata: {"author":"ClawBio + Genomic Intelligence","demo_data":[{"description":"TP53 locus (chr17:7668402-7687550, GRCh38, 19 kbp) — bundled real reference sequence.","path":"example_data/annotation_tp53.fa"}],"dependencies":{"packages":["requests\u003e=2.31"],"python":"\u003e=3.10"},"domain":"genomics","endpoints":{"cli":"python skills/gi-annotation/gi_annotation.py --input {input_file} --output {output_dir}"},"inputs":[{"description":"Single-record FASTA (genomic region; can be tens to hundreds of kbp).","format":["fa","fasta","fna"],"name":"input_file","required":false,"type":"file"}],"openclaw":{"always":false,"emoji":"📜","homepage":"https://docs.genomicintelligence.ai","install":[{"bins":null,"kind":"pip","package":"requests"}],"os":["darwin","linux"],"requires":{"bins":["python3"],"config":null,"env":null},"trigger_keywords":["gene annotation","transcript annotation","annotate sequence","gene structure prediction","predict transcripts","de novo gene prediction","DNA annotation","gene boundaries","exon prediction","gi annotation","genomic intelligence annotation"]},"outputs":[{"description":"Markdown report — predicted transcripts with start / end / strand.","format":"md","name":"report","type":"file"},{"description":"Full `{data, meta}` response with per-transcript structure.","format":"json","name":"result","type":"file"},{"description":"command.sh + environment.json.","name":"reproducibility","type":"directory"}],"tags":["genomics","annotation","gene-prediction","transcript-prediction","gene-structure","dna-lm","gi-api"],"version":"0.1.0"}
---
