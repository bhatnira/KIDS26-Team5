...
license: "MIT"
metadata: {"author":"ClawBio + Genomic Intelligence","demo_data":[{"description":"Chr19 active-promoter region — bundled real human reference sequence.","path":"example_data/chromatin_active_promoter_chr19.fa"}],"dependencies":{"packages":["requests\u003e=2.31"],"python":"\u003e=3.10"},"domain":"genomics","endpoints":{"cli":"python skills/gi-chromatin/gi_chromatin.py --input {input_file} --output {output_dir}"},"inputs":[{"description":"Single-record FASTA (any length; API windows automatically).","format":["fa","fasta","fna"],"name":"input_file","required":false,"type":"file"}],"openclaw":{"always":false,"emoji":"🧶","homepage":"https://docs.genomicintelligence.ai","install":[{"bins":null,"kind":"pip","package":"requests"}],"os":["darwin","linux"],"requires":{"bins":["python3"],"config":null,"env":null},"trigger_keywords":["chromatin","chromatin state","chromatin annotation","histone mark","histone modification","DNase","ATAC","TF binding","transcription factor binding","DeepSEA","epigenome","gi chromatin","genomic intelligence chromatin"]},"outputs":[{"description":"Markdown report — windows processed, total annotations across tracks, model + timing.","format":"md","name":"report","type":"file"},{"description":"Full `{data, meta}` response with per-window per-track predictions.","format":"json","name":"result","type":"file"},{"description":"command.sh + environment.json.","name":"reproducibility","type":"directory"}],"tags":["genomics","chromatin","histone","DNase","ATAC","TF-binding","deepsea","dna-lm","gi-api"],"version":"0.1.0"}
---
