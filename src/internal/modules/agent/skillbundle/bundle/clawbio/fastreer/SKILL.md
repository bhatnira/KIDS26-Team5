...
license: "GPL-3.0"
metadata: {"author":"Anestis Gkanogiannis","demo_data":[{"description":"Synthetic VCF with 5 samples and 20 biallelic SNPs on chr1","path":"examples/demo_samples.vcf"},{"description":"Synthetic FASTA with 5 sequences of 60 bp each","path":"examples/demo_sequences.fasta"}],"dependencies":{"packages":["fastreer\u003e=2.2.0"],"python":"\u003e=3.10","system":["java\u003e=11"]},"domain":"phylogenetics","endpoints":{"cli":"python skills/fastreer/fastreer.py --command {command} --input {input_file} --output {output_dir}"},"inputs":[{"description":"VCF file (biallelic/multiallelic SNPs, compressed or plain), FASTA file (aligned or unaligned sequences, compressed or plain), or PHYLIP distance matrix (for DIST2TREE).","format":["vcf","vcf.gz","fasta","fasta.gz","fa","fa.gz","fas","fas.gz","dist"],"name":"input_file","required":true,"type":"file"}],"openclaw":{"always":false,"emoji":"🌳","homepage":"https://github.com/ClawBio/ClawBio","install":[{"kind":"pip","package":"fastreer"}],"os":["darwin","linux"],"requires":{"bins":["python3","java"]},"trigger_keywords":["phylogenetic tree","distance matrix from VCF","VCF","VCF2TREE","VCF2DIST","fastreer","fastreeR","genomic distance","hierarchical clustering tree","k-mer distance","FASTA2DIST","variant distance matrix","population tree","DIST2TREE","cosine distance VCF","sample phylogeny"]},"outputs":[{"description":"Newick phylogenetic tree (VCF2TREE / DIST2TREE)","format":["nwk"],"name":"tree","type":"file"},{"description":"PHYLIP distance matrix (VCF2DIST / FASTA2DIST)","format":["dist"],"name":"distances","type":"file"},{"description":"Analysis summary with sample list and interpretation","format":["md"],"name":"report","type":"file"},{"description":"Machine-readable metadata (samples, command, paths)","format":["json"],"name":"result","type":"file"}],"tags":["phylogenetics","distance-matrix","tree-building","vcf","fasta","population-genomics"],"version":"0.1.0"}
---
