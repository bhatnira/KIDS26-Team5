...
license: "MIT"
metadata: {"author":"ClawBio","demo_data":[{"description":"Synthetic twelve-guide, six-gene CRISPR screen table","path":"demo_screen_counts.csv"}],"dependencies":{"packages":null,"python":"\u003e=3.10"},"domain":"functional-genomics","endpoints":{"cli":"python skills/crispr-screen-triage/crispr_screen_triage.py --input {input_file} --output {output_dir}"},"inputs":[{"description":"Guide-level CRISPR count and annotation table","format":["csv"],"name":"input_file","required":true,"type":"file"}],"openclaw":{"always":false,"emoji":"🧬","homepage":"https://github.com/ClawBio/ClawBio","install":null,"os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["CRISPR screen triage","guide count ranking","rank CRISPR hits","depleted guide screen"]},"outputs":[{"description":"Ranked hit report","format":["md"],"name":"report","type":"file"},{"description":"Machine-readable triage results","format":["json"],"name":"result","type":"file"}],"tags":["crispr","screen","triage"],"version":"0.1.0"}
---
