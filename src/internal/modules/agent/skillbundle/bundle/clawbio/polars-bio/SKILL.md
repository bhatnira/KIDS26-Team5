---
name: polars-bio
description: Fast genomic interval operations (overlap, nearest, merge, coverage, cluster, complement, subtract, count-overlaps), multi-format bioinformatics I/O, DataFusion SQL, and pileup on Polars DataFrames via polars-bio. A scalable bioframe/bedtools alternative.
license: "Apache-2.0"
metadata: {"author":"ClawBio (adapted from K-Dense scientific-agent-skills/polars-bio)","demo_data":[{"description":"Synthetic BED6 interval set A (5 intervals, chr1/chr2)","path":"examples/demo_a.bed"},{"description":"Synthetic BED6 interval set B (4 intervals)","path":"examples/demo_b.bed"},{"description":"Synthetic 4-variant VCF (io/sql demos)","path":"examples/demo.vcf"}],"dependencies":{"packages":["polars-bio","matplotlib"],"python":"\u003e=3.11,\u003c3.15"},"domain":"genomics","endpoints":{"cli":"python skills/polars-bio/polars_bio_runner.py {subcommand} --input {input_file} --output {output_dir}"},"inputs":[{"description":"BED interval file (\u003e=4 columns) for interval ops; or any supported format for io/sql; or an indexed BAM (with .bai) for pileup.","format":["bed","vcf","gff","gtf","fasta","fastq","bam","cram","sam","pairs","bigwig","bigbed"],"name":"input_file","required":true,"type":"file"}],"openclaw":{"always":false,"emoji":"🐻","homepage":"https://github.com/ClawBio/ClawBio","install":[{"kind":"pip","package":"polars-bio"}],"os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["interval overlap","nearest interval","merge intervals","genomic coverage","BED intersect","bioframe","polars-bio","interval arithmetic","complement intervals","subtract intervals","count overlaps","DataFusion SQL genomic","BigWig","BigBed","genomic pileup depth"]},"outputs":[{"description":"Operation summary with parameters, schema, interpretation, disclaimer","format":["md"],"name":"report","type":"file"},{"description":"Machine-readable metadata (subcommand, params, row counts, schema, version)","format":["json"],"name":"result","type":"file"},{"description":"Interval/coverage visualization (interval ops and pileup)","format":["png"],"name":"figure","type":"file"},{"description":"Result table (NDJSON fallback for nested columns)","format":["csv","ndjson"],"name":"table","type":"file"}],"tags":["genomic-intervals","interval-arithmetic","bioframe-alternative","file-io","datafusion-sql","polars"],"version":"0.1.0"}
---
