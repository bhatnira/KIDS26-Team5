...
license: "MIT"
metadata: {"author":"Manuel Corpas","openclaw":{"always":false,"emoji":"📸","homepage":"https://github.com/ClawBio/ClawBio","os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["drug photo","medication photo","pill photo","drug image"]},"tags":["pharmacogenomics","computer-vision","drug-identification","dosage-guidance"],"version":"0.1.0"}
---
