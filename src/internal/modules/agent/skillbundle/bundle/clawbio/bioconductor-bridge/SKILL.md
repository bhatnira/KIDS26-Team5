...
license: "MIT"
metadata: {"author":"Hiranyamaya Dash","openclaw":{"always":false,"emoji":"🧬","homepage":"https://github.com/ClawBio/ClawBio","os":["darwin","linux"],"requires":{"bins":["python3","Rscript"]},"trigger_keywords":["bioconductor","bioc","biocmanager","summarizedexperiment","singlecellexperiment","genomicranges","variantannotation","annotationhub","experimenthub","which bioconductor package","what package should i use","set up bioconductor"]},"tags":["bioconductor","r","package-discovery","workflows","transcriptomics","genomics","single-cell","annotation"],"version":"0.1.0"}
---
