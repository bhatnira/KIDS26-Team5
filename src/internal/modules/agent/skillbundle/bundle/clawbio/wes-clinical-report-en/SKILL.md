...
description: Generates professional clinical PDF reports in English from WES (Whole Exome Sequencing) data with clinical interpretation summary, pharmacogenomic alerts, and follow-up recommendations.
license: "PROPRIETARY"
metadata: {"author":"Manuel Corpas","inputs":[{"description":"Structured WES report with sections 1-7 (Exome Summary through Methods)","format":"markdown (.md)","name":"WES markdown report","required":true},{"description":"Left institutional logo for cover and header","format":"image (JPG/PNG)","name":"Logo left","required":false},{"description":"Right institutional logo for cover and header","format":"image (JPG/PNG)","name":"Logo right","required":false}],"openclaw":{"always":false,"dependencies":["reportlab","pandas"],"emoji":"🧬","homepage":"https://github.com/ClawBio/ClawBio","min_python":"3.9","os":["darwin","linux"],"private":true,"requires":{"bins":["python3"]},"trigger_keywords":["WES clinical report","exome PDF report english","clinical report english","Novogene report english","WES report PDF"]},"outputs":[{"description":"Professional clinical report with interpretation, tables, and disclaimer","format":"PDF (A4)","name":"Clinical PDF report"}],"tags":["WES","exome","clinical-report","english","pharmacogenomics","PDF","ANNOVAR"],"version":"1.0.0"}
---
