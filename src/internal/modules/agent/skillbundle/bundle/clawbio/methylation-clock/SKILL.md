...
license: "MIT"
metadata: {"openclaw":{"always":false,"emoji":"🕰️","homepage":"https://github.com/ClawBio/ClawBio","install":[{"kind":"pip","package":"pandas"},{"kind":"pip","package":"numpy"},{"kind":"pip","package":"matplotlib"},{"kind":"pip","package":"pyaging"}],"os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["epigenetic age","methylation clock","pyaging","Horvath","GrimAge","DunedinPACE","GEO","GSE"]},"tags":["epigenetics","methylation","aging","clock","pyaging","GEO","illlumina-450k","EPIC"],"version":"0.1.0"}
---
