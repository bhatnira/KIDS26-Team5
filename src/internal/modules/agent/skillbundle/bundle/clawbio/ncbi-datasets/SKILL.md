...
license: "MIT"
metadata: {"author":"nullvoid42","domain":"datasets","openclaw":{"always":false,"emoji":"🧬","homepage":"https://www.ncbi.nlm.nih.gov/datasets/","install":[{"bins":["datasets","dataformat"],"channel":"conda-forge","kind":"conda","package":"ncbi-datasets-cli"}],"os":["darwin","linux","win32"],"requires":{"bins":["datasets","dataformat"],"config":null,"env":null},"trigger_keywords":["ncbi","datasets download","datasets summary","dataformat","download genome","download gene","reference genome","genome accession","gene symbol","ortholog","download virus","sars-cov-2 sequence","taxonomy data","dehydrated download","rehydrate","GCF","GCA"]},"tags":["ncbi","genomics","bioinformatics","genome-download","gene","virus","taxonomy","datasets","dataformat","refseq","genbank"],"version":"0.1.0"}
---
