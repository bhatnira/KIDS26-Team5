...
license: "MIT"
metadata: {"author":"ClawBio + Genomic Intelligence","demo_data":[{"description":"HBB gene body (chr11, GRCh38; reverse-complemented to gene-sense) — bundled real reference sequence.","path":"example_data/splice_hbb.fa"}],"dependencies":{"packages":["requests\u003e=2.31"],"python":"\u003e=3.10"},"domain":"genomics","endpoints":{"cli":"python skills/gi-splice/gi_splice.py --input {input_file} --output {output_dir}"},"inputs":[{"description":"Single-record FASTA, typically a gene body (5'UTR → 3'UTR including introns).","format":["fa","fasta","fna"],"name":"input_file","required":false,"type":"file"}],"openclaw":{"always":false,"emoji":"✂️","homepage":"https://docs.genomicintelligence.ai","install":[{"bins":null,"kind":"pip","package":"requests"}],"os":["darwin","linux"],"requires":{"bins":["python3"],"config":null,"env":null},"trigger_keywords":["splice","splice site","splice donor","splice acceptor","splicing prediction","intron exon boundary","cryptic splice site","GT-AG site","gi splice","G0 splice","genomic intelligence splice"]},"outputs":[{"description":"Markdown report — sequence + model metadata, called splice sites (position, kind, strand, probability).","format":"md","name":"report","type":"file"},{"description":"Full `{data, meta}` response from the GI API plus a flattened summary.","format":"json","name":"result","type":"file"},{"description":"command.sh + environment.json for exact-rerun reproducibility.","name":"reproducibility","type":"directory"}],"tags":["genomics","splice","splice-site","splicing","intron-exon","dna-lm","transformer","gi-api"],"version":"0.1.0"}
---
