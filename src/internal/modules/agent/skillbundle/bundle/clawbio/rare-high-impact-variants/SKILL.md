...
description: Count rare, high-impact loss-of-function variants carried in a VCF, annotated with molecular consequence and population allele frequency
license: "MIT"
metadata: {"author":"Manuel Corpas","demo_data":[{"description":"Synthetic test data","path":"demo_input.txt"}],"dependencies":{"python":"\u003e=3.11"},"domain":"genomics","endpoints":{"cli":"python skills/rare-high-impact-variants/rare_high_impact_variants.py --input {input_file} --output {output_dir}"},"inputs":[{"description":"Primary input data file","format":["vcf","csv","tsv","txt"],"name":"input_file","required":true,"type":"file"}],"openclaw":{"always":false,"homepage":"https://github.com/ClawBio/ClawBio","install":[{"kind":"pip","package":"pandas"}],"os":["macos","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["count","rare,","high-impact"]},"outputs":[{"description":"Analysis report","format":"md","name":"report","type":"file"},{"description":"Machine-readable results","format":"json","name":"result","type":"file"}],"tags":["count","rare","high-impact","loss-of-function","variant-burden","lof"],"version":"0.1.0"}
---
