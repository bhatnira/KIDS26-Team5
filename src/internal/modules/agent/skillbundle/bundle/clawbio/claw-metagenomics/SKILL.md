...
license: "MIT"
metadata: {"author":"Manuel Corpas","inputs":[{"description":"Forward reads (paired-end FASTQ R1)","format":["fastq","fastq.gz","fq","fq.gz"],"name":"r1","type":"file"},{"description":"Reverse reads (paired-end FASTQ R2)","format":["fastq","fastq.gz","fq","fq.gz"],"name":"r2","type":"file"},{"description":"Single concatenated or interleaved FASTQ (alternative to R1+R2)","format":["fastq","fastq.gz","fq","fq.gz"],"name":"input","type":"file"}],"openclaw":{"always":false,"category":"bioinformatics","dependencies":["pandas","numpy","matplotlib","seaborn","scipy","biopython"],"emoji":"🦠","homepage":"https://github.com/ClawBio/ClawBio","min_python":"3.9","os":["darwin","linux"],"requires":{"bins":["python3"]},"system_dependencies":["kraken2","bracken","rgi","humann"]},"outputs":[{"description":"Bracken-adjusted species-level taxonomy abundance table","format":"tsv","name":"taxonomy_report","type":"file"},{"description":"RGI/CARD antimicrobial resistance gene hits with WHO priority classification","format":"tsv","name":"resistome_profile","type":"file"},{"description":"HUMAnN3 pathway abundance table (MetaCyc/UniRef)","format":"tsv","name":"functional_pathways","type":"file"},{"description":"Publication-quality figures (taxonomy bar chart, resistome heatmap, WHO-critical ARG summary)","format":["png","pdf"],"name":"figures","type":"directory"},{"description":"commands.sh, environment.yml, checksums.sha256","name":"reproducibility","type":"directory"}],"tags":["metagenomics","antimicrobial-resistance","taxonomy","functional-profiling","environmental","WHO-critical-ARGs"],"version":"0.1.0"}
---
