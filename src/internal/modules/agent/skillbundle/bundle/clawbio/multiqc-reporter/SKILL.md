...
description: Aggregates QC reports from any bioinformatics tool outputs (FastQC, fastp, STAR, Picard, samtools, etc.) into a single MultiQC HTML report plus a ClawBio markdown summary with per-sample QC metrics.
license: "MIT"
metadata: {"author":"Cameron Lloyd","demo_data":[{"description":"Synthetic FastQC output for 3 samples (generated at runtime into a tempdir)","path":"--demo flag"}],"dependencies":{"external":["multiqc\u003e=1.20"],"python":"\u003e=3.11"},"domain":"genomics","endpoints":{"cli":"python skills/multiqc-reporter/multiqc_reporter.py --input {input_dirs} --output {output_dir}"},"inputs":[{"description":"One or more directories containing tool QC output files","format":["any"],"name":"input_dirs","required":true,"type":"directory"}],"openclaw":{"always":false,"emoji":"📊","homepage":"https://github.com/ClawBio/ClawBio","install":[{"bins":["multiqc"],"kind":"pip","package":"multiqc"}],"os":["darwin","linux"],"requires":{"bins":["python3","multiqc"]},"trigger_keywords":["multiqc","aggregate QC","QC report","FastQC summary","multi-sample QC","sequencing QC report","combine QC","QC aggregation"]},"outputs":[{"description":"ClawBio markdown summary with per-sample QC table","format":"md","name":"report","type":"file"},{"description":"Standard MultiQC interactive HTML report","format":"html","name":"html_report","type":"file"}],"tags":["qc","fastqc","multiqc","sequencing","alignment","rna-seq","wgs","wes","aggregation"],"version":"0.1.0"}
---
