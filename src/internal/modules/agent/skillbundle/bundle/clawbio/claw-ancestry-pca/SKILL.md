...
license: "MIT"
metadata: {"author":"Manuel Corpas","inputs":[{"description":"VCF file with genotype data for your study cohort","format":["vcf","vcf.gz"],"name":"vcf","type":"file"},{"description":"Tab-separated file mapping sample IDs to population labels","format":["tsv","txt"],"name":"pop-map","type":"file"}],"openclaw":{"always":false,"category":"bioinformatics","dependencies":["pandas","numpy","matplotlib","scikit-learn","adjustText"],"emoji":"🧬","homepage":"https://github.com/ClawBio/ClawBio","min_python":"3.9","os":["darwin","linux"],"requires":{"bins":["python3"]},"system_dependencies":["plink","bcftools"]},"outputs":[{"description":"Multi-panel PCA composite figure showing ancestry decomposition","format":["png","pdf"],"name":"figure","type":"file"},{"description":"Ancestry analysis report with population assignments and statistics","format":"markdown","name":"report","type":"file"}],"tags":["population-genetics","PCA","ancestry","SGDP","global-diversity"],"version":"0.1.0"}
---
