...
description: Classify germline variants from VCF/BCF files according to the ACMG/AMP 2015 28-criteria evidence framework and generate clinical-grade interpretation reports with per-variant evidence audit trails and ACMG SF v3.2 secondary findings screening.
license: "MIT"
metadata: {"author":"Reza","openclaw":{"always":false,"emoji":"🏥","homepage":"https://github.com/ClawBio/ClawBio","install":[{"kind":"pip","package":"pysam"},{"kind":"pip","package":"requests"},{"kind":"pip","package":"pandas"}],"os":["darwin","linux"],"requires":{"bins":["python3"]},"trigger_keywords":["ACMG","ACMG classification","pathogenic variant","likely pathogenic","variant of uncertain significance","VUS","clinical variant","germline classification","secondary findings","ACMG SF","variant interpretation"]},"tags":["acmg","variant-classification","clinical-genomics","pathogenicity","germline","secondary-findings","exome","genome"],"version":"0.1.0"}
---
