...
license: "MIT"
metadata: {"author":"ClawBio Contributors","demo_data":[{"description":"Synthetic 5-sequence FASTA with bacteria-like completeness C:95.2%[S:93.1%,D:2.1%],F:2.3%,M:2.5%,n:124","path":"--demo flag"}],"dependencies":{"external":["busco\u003e=6.0 (runtime; not required for --demo)","hmmer\u003e=3.1 (installed with BUSCO via conda)","sepp==4.5.5 (auto-lineage only — v4.5.6 is incompatible)"],"packages":null,"python":"\u003e=3.10"},"domain":"genomics","endpoints":{"cli":"python skills/busco-assessor/busco_assessor.py --input {input} --mode genome --output {output_dir}"},"inputs":[{"description":"Assembly, transcriptome, or protein FASTA (required unless --demo)","format":["fasta","fna","fa","faa"],"name":"input","required":true,"type":"file"}],"openclaw":{"always":false,"emoji":"🧬","homepage":"https://busco.ezlab.org/","install":[{"channels":["bioconda","conda-forge"],"kind":"conda","package":"busco=6.0.0"},{"channels":["bioconda","conda-forge"],"kind":"conda","package":"sepp=4.5.5"}],"os":["darwin","linux"],"requires":{"bins":["python3"],"config":null,"env":null},"trigger_keywords":["genome completeness","BUSCO score","BUSCO assessment","assembly quality","check my assembly","BUSCO genome mode","completeness metrics","assembly QC","transcriptome completeness","protein set completeness","auto-lineage","busco -m genome","how complete is my genome","BUSCO bacteria","run BUSCO"]},"outputs":[{"description":"Markdown completeness report with interpretation","format":"md","name":"report","type":"file"},{"description":"Machine-readable completeness scores (C/S/D/F/M/n)","format":"json","name":"result","type":"file"},{"description":"Raw BUSCO outputs (short_summary.txt, full_table.tsv, short_summary.json)","name":"busco_run","type":"directory"},{"description":"commands.sh, environment.yml, checksums.sha256","name":"reproducibility","type":"directory"}],"tags":["busco","genome-completeness","assembly-qc","transcriptome","lineage","orthodb","hmmer","prokaryote","eukaryote"],"version":"0.1.0"}
---
