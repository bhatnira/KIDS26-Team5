...
license: "MIT"
metadata: {"openclaw":{"always":false,"emoji":"🔬","homepage":"https://github.com/ClawBio/ClawBio","install":[{"kind":"pip","package":"requests"},{"kind":"pip","package":"matplotlib"},{"kind":"pip","package":"numpy"},{"kind":"pip","package":"pandas"}],"os":["darwin","linux"],"requires":{"bins":["python3"]}},"version":"0.1.0"}
---
