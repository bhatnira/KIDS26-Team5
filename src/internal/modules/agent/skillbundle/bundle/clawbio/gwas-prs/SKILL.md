...
license: "MIT"
metadata: {"openclaw":{"always":false,"emoji":"🎯","homepage":"https://www.pgscatalog.org","install":[{"kind":"uv","package":"requests"}],"os":["darwin","linux"],"requires":{"bins":["python3"]}},"version":"0.1.0"}
---
