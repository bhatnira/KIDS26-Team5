...
license: "MIT"
metadata: {"author":"Santiago Rodriguez Salinas","demo_data":[{"description":"Synthetic ~720 bp nucleotide sequence with a small ORF (CC0, no real organism)","path":"example_data/demo_nucleotide.fasta"},{"description":"Synthetic ~120 aa protein sequence (CC0, no real organism)","path":"example_data/demo_protein.fasta"}],"dependencies":{"packages":["biopython\u003e=1.80"],"python":"\u003e=3.10"},"domain":"genomics","endpoints":{"cli":"python skills/analyze-fasta/analyze_fasta.py --input {input_file} --output {output_dir}"},"inputs":[{"description":"Single FASTA file with one or more nucleotide or protein records","format":["fasta","fa","fna","faa"],"name":"input","required":true,"type":"file"}],"openclaw":{"always":false,"emoji":"🧬","homepage":"https://github.com/ClawBio/ClawBio","install":[{"bins":null,"kind":"pip","package":"biopython"}],"os":["darwin","linux"],"requires":{"bins":["python3"],"config":null,"env":null},"trigger_keywords":["fasta","analyze fasta","analiza fasta","sequence analysis","gc content","find orfs","orf finder","protein properties","isoelectric point","gravy index","protparam","molecular weight protein","molecular weight dna"]},"outputs":[{"description":"Markdown report with summary table, per-sequence metrics, and disclaimer","format":["md"],"name":"report","type":"file"},{"description":"Machine-readable analysis results (sequence type, per-record metrics, summary)","format":["json"],"name":"result","type":"file"},{"description":"Standalone HTML rendering of the same report for visual inspection","format":["html"],"name":"report_html","type":"file"},{"description":"Directory with commands.sh and run.json describing the exact run","name":"reproducibility","type":"directory"}],"tags":["fasta","biopython","sequence-analysis","gc-content","orf","protein-properties","isoelectric-point","gravy"],"version":"0.1.0"}
---
